...
Chemical reactions in physical models are also described as differential equation systems. 
The following is a classic model of dynamics between different species of pollutants:
"""
...
plot(sol)
savefig("pollution_sol.png")

plot(sol, xscale=:log10, tspan=(1e-6, 60), layout=(3,1))
savefig("pollution_sol2.png")
